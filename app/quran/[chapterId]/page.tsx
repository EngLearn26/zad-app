...
export default function ChapterPage() {
  ...
  // إظهار البسملة كعنوان ما عدا في الفاتحة والتوبة
  ...
  return (
    ...
    >
      <SadqaBadge name="محمد زكريا عبدالرحمن" className="justify-center" />
      ...
      <div className="container mx-auto py-8 max-w-4xl">
        ...
        {/* 3. نص الآيات */}
        <div
          className={`text-center leading-[2.5] md:leading-[3] font-amiri text-2xl md:text-4xl px-6 py-10 rounded-[2rem] border-2 shadow-sm
          ${
            darkMode
        ...
        >
          {surah.verses.map((ayah, index) => {
            ...
            // إزالة البسملة من نص الآية الأولى إذا كانت معروضة كعنوان
            if (
              showBismillahHeader &&
              index === 0 &&
            ...
            return (
              ...
              >
                ...
                >
                  {/* محاولة استخراج رقم الآية من verse_key */}
