...
export default function Header() {
  ...
  const isQuickAccessPage =
    pathname === "/" || pathname === "/plan" || pathname === "/feedback";
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-40 shadow-sm backdrop-blur-md transition-colors relative ${darkMode ? "bg-slate-900/95 border-b border-slate-700" : "bg-white/95 border-b border-amber-200"}`}
      >
