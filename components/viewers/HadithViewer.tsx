              ...
              {bookContent.map((section) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`truncate font-amiri text-base ${isRead ? "opacity-50 line-through decoration-amber-500/50" : ""}`}
                    >
                      {section.title}
                    </span>
                  </button>
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-bold ${darkMode ? "bg-amber-900/30 text-amber-400" : "bg-amber-100 text-amber-800"}`}
                        >
                          {item.type === "intro"
                            ? "مقدمة"
                            : `الفقرة رقم ${index}`}
                      ...
                      <h2
                        className={`text-2xl md:text-3xl lg:text-4xl font-bold font-amiri leading-normal ${darkMode ? "text-slate-100" : "text-slate-800"}`}
                      >
                        {item.title}
                      </h2>
                    </div>
                      ...
                      <>
                        {item.matn && (
                          <section className="relative">
                            ...
                            >
                              <p
                                className={`text-[18px] md:text-2xl font-amiri leading-loose font-bold ${darkMode ? "text-amber-200" : "text-amber-900"}`}
                              >
                                {item.matn}
                              </p>
                            </div>
